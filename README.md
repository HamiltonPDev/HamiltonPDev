<!-- ─────────────────────────────────────────────────────────────────────────────
     ...
     Theme-aware (light + dark) via #gh-light-mode-only / #gh-dark-mode-only
     URL fragments. More reliable through GitHub camo proxy than <picture>.
...
<!-- ── Contact + profile-views badges (theme-agnostic) ─────────────────────── -->
<p align="center">
...
→ **Sevilla PMS** · `Ideation` · Multi-tenant PMS for the Spanish rental market. Anchored in a real portfolio: six apartments and twenty-four tenants in Sevilla. Stack and tooling currently under exploration.
...
<!-- NOTE: github-readme-stats.vercel.app section removed temporarily —
     service was returning HTTP 503 across all endpoints (2026-05-23).
     Re-add Stats + Top-Languages cards once the deployment recovers. -->
